<footer class="w-100 bt b--near-black bw2 mt4 ph2 ph3-ns ph6-l pv4-l f5">
  <section property="newsletter" class="dt center w-100 mb4">
    <div class="dtc tc v-mid w-100">
      <p class="f3">
        Find out what's next first.
      </p>
      <input placeholder="Email Address" class="input-reset inline-flex items-center mw-100 w-100 w5-ns tc  pv3 ph4 border-box ba b--black">
      <input type="submit" class="input-reset inline-flex items-center w-100 w-auto-ns pv2 pv3-ns ph4 bg-light-blue ba b--black bg-animate hover-bg-black hover-white">
    </div>
  </section>
  <section class="dt w-100" >
  <div class="db dtc-ns tc tl-ns v-mid">
    <a href="https://www.facebook.com/" class="link dim dib mr3 black-70" title="Facebook">
    ...
    <a href="https://medium.com/" class="link dim dib mr3 black-70" title="Medium">
